                          ...
                          GestureDetector(
                            onTap: () => Navigator.push(context,
                              MaterialPageRoute(builder: (_) =>
                                AdminAccountSettings(admin: widget.admin))),
                            child: Container(
                              width: 44, height: 44,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _MenuTile(
                        ...
                        onTap: () => Navigator.push(context,
                          MaterialPageRoute(
                            builder: (_) => const ManageProfessors()))
                          .then((_) => _loadStats()),
                      ),
                      ...
                      _MenuTile(
                        ...
                        onTap: () => Navigator.push(context,
                          MaterialPageRoute(
                            builder: (_) => const ManageSubjects()))
                          .then((_) => _loadStats()),
                      ),
                      const SizedBox(height: 12),
                      _MenuTile(
                        ...
                        onTap: () => Navigator.push(context,
                          MaterialPageRoute(
                            builder: (_) => const ManageSections()))
                          .then((_) => _loadStats()),
                      ),
                      const SizedBox(height: 12),
                      _MenuTile(
                        ...
                        onTap: () => Navigator.push(context,
                          MaterialPageRoute(
                            builder: (_) => const ManageStudents()))
                          .then((_) => _loadStats()),
                      ),
                      const SizedBox(height: 12),
                      _MenuTile(
