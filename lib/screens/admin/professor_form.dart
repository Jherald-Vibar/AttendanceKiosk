...
class _ProfessorFormState extends State<ProfessorForm> {
  ...
  void initState() {
    ...
    if (_isEdit) {
      ...
      _employeeIdCtrl.text = p['employee_id'] ?? '';
  ...
  @override
  void dispose() {
    _employeeIdCtrl.dispose(); _fullNameCtrl.dispose();
    _emailCtrl.dispose(); _departmentCtrl.dispose();
  ...
  Future<void> _save() async {
    if (_employeeIdCtrl.text.trim().isEmpty ||
      ...
      _showError('Employee ID, Full Name and Username are required.');
      return;
    }
    ...
    try {
      final data = {
        ...
        if (_passwordCtrl.text.isNotEmpty) 'password': _passwordCtrl.text.trim(),
      };

      if (_isEdit) {
        await DatabaseHelper.instance.updateProfessor(
            widget.professor!['id'], data);
      } else {
      ...
      _showError('Error: Employee ID or Username already exists.');
    } finally {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(_isEdit ? 'Edit Professor' : 'Add Professor',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _FormField(controller: _employeeIdCtrl,
                      label: 'Employee ID *', hint: 'e.g. EMP-001',
                      icon: Icons.badge_rounded),
                  const SizedBox(height: 14),
                  _FormField(controller: _fullNameCtrl,
                      label: 'Full Name *', hint: 'e.g. Juan dela Cruz',
                      icon: Icons.person_rounded),
                  const SizedBox(height: 14),
                  _FormField(controller: _emailCtrl,
                      label: 'Email', hint: 'e.g. juan@school.edu',
                      icon: Icons.email_rounded,
                      keyboardType: TextInputType.emailAddress),
                  const SizedBox(height: 14),
                  _FormField(controller: _departmentCtrl,
                      label: 'Department', hint: 'e.g. Computer Science',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  _FormField(controller: _usernameCtrl,
                      label: 'Username *', hint: 'e.g. jdelacruz',
                  ...
                  _FormField(
                    ...
                    suffixIcon: GestureDetector(
                      ...
                      child: Icon(
                        ...
                        color: const Color(0xFF8B9DC3), size: 20,
                      ),
                    ),
                  ),
                ],
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isLoading
                    ...
                    : Text(_isEdit ? 'Update Professor' : 'Add Professor',
    ...
    return Column(
      ...
      children: [
        Text(label, style: const TextStyle(
          color: Color(0xFF8B9DC3), fontSize: 12, fontWeight: FontWeight.w600)),
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: hint,
            hintStyle: const TextStyle(color: Color(0xFF3D4F6B), fontSize: 14),
            prefixIcon: Icon(icon, color: const Color(0xFF8B9DC3), size: 18),
